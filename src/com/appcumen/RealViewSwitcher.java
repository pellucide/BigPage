...
import com.appcumen.RealViewSwitcher;
...
/**
 * RealViewSwitcher allows users to switch between multiple screens (layouts) 
 * in the same way as the Android home screen (Launcher application).
 * <p>
 * You can add and remove views using the normal methods 
 * {@link ViewGroup#addView(View)}, {@link ViewGroup#removeView(View)} etc.
 *  You may want to listen for updates by calling
 *   {@link RealViewSwitcher#setOnScreenSwitchListener(OnScreenSwitchListener)}
...
public class RealViewSwitcher extends ViewGroup {
	...
	// TODO: This class does the basic stuff right now, but it would be cool to have
	// certain things implemented, e.g. using an adapter for getting views instead of
	// setting them directly, memory management and the  possibility of scrolling
	// vertically instead of horizontally. If you have ideas or patches, please visit
